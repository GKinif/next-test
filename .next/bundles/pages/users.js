...
/******/ 	var hotCurrentHash = "0b4617abb7a0a0c964d1"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _set = __webpack_require__(123);
	...
	var _sideEffect = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(6)
	  ...
	  , each           = __webpack_require__(136)(0)
	  , DESCRIPTORS    = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CSSPropertyOperations = __webpack_require__(156);

	var _clean = __webpack_require__(164);

	var _clean2 = _interopRequireDefault(_clean);

	var _plugins = __webpack_require__(165);

	var _hash = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _camelizeStyleName = __webpack_require__(157);

	var _camelizeStyleName2 = _interopRequireDefault(_camelizeStyleName);

	var _dangerousStyleValue = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CSSProperty = __webpack_require__(160);
	...
	if(true) {
		...
		var check = function check() {
			module.hot.check(true, function(err, updatedModules) {
				...
				__webpack_require__(169)(updatedModules, updatedModules);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserList = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserServices = __webpack_require__(176);
	...
	var _class = function (_React$Component) {
	    ...
	    function _class(props) {
	        ...
	        _this.userServices = new _UserServices2.default();
	        _this.updateList();
	        return _this;
	    }
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        value: function updateList() {
	            ...
	            this.userServices.getUsers(5).then(function (response) {
	                var results = JSON.parse(response).results;
	                _this2.setState({ userList: results });
	            }).catch(function (error) {
	                return console.log('Unable to get Users: ', error);
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var userList = this.state.userList.map(function (user) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: user.id.value + '-' + user.name.first + '-' + user.name.last },
	                    user.name.first,
	                    ' ',
	                    user.name.last
	                );
